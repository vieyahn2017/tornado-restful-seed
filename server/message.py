...
class MessageBackEnd(object):
    ...
    def subscribe(self, topic, queue_name, callback):
        pass

    def publish(self, topic, queue_name, body, callback):
        pass
...
class ChannelProxy(object):
    ...
    def on_queue_declared(self, future, method_frame):
...
class RabbitBackend(MessageBackEnd):
    ...
    def open_channel(self, callback=None):
        """
        :param callback: 如果提供了callback,则在channel 成功打开后调用callback通知
